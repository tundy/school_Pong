...
{
    context.drawImage(this.img, 17, this.side*16, 72-17*2, 16, this.x-this.width/2+16, this.y-this.height/2, this.width-16*2, this.height);
    context.drawImage(this.img, 0, this.side*16, 17, 16, this.x-this.width/2, this.y-this.height/2, 17, this.height);
    context.drawImage(this.img, 72-17, this.side*16, 17, 16, this.x+this.width/2-17, this.y-this.height/2, 17, this.height);
